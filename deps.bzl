...
def go_dependencies():
    ...
    pass
    go_repository(
        name = "com_github_aws_constructs_go_constructs",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/aws/constructs-go/constructs",
        sum = "h1:pOtaNswTRhWeAOlaxmfyzoZHwrtUaFWJbU2H/AqmCLk=",
        version = "v0.0.0-20210203051210-8754df3d2bfd",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_sourcegraph_controller_cdktf_gen_tfe",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/sourcegraph/controller-cdktf/gen/tfe",
        sum = "h1:V88MKptyWOJv2a57V946/ak/9oLGbs+GHHgoGM4eOwM=",
        version = "v0.0.0-20230405124738-cce6ca6cf969",
    )
    go_repository(
